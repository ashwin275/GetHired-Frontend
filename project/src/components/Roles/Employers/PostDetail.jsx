...
function PostDetail() {
  ...
  const ConfirmDelete = async () => {
    ...
    try {
      const response = await axiosInstance.delete(`recruiters/delete-post/${postId}/`);
  ...
  return (
   ...
   <div className='flex flex-col lg:flex-row  lg:justify-between lg:p-8'>
    <div className="text-center justify-space">
                    ...
                    <p className="mb-2  text-start text-gray-600 sm:text-lg "><span className='text-slate-400 uppercase font-serif text-base'>Work Mode :</span> {detail.workmode}</p>
