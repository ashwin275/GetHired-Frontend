    ...
    <div className="flex justify-center">
      <div className="w-5/6  md:h-[35rem]">
        <div className="flex flex-wrap md:flex-nowrap ">
          ...
          {/* .......................mid.............................. */}
          <div
            className={`w-full md:w-4/6 lg:${
              userInfo.is_seeker ? "w-5/6" : "w-4/6"
            }  flex justify-center items-center  lg:max-h-[40rem] `}
          >
